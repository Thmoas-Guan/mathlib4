...
protected theorem postcomp_isUniformInducing [UniformSpace γ] {f : γ → β} (hf : IsUniformInducing f) :
...
protected theorem postcomp_uniformEmbedding [UniformSpace γ] {f : γ → β} (hf : UniformEmbedding f) :
  ...
  toIsUniformInducing := UniformFun.postcomp_isUniformInducing hf.toIsUniformInducing
...
protected theorem postcomp_uniformEmbedding [UniformSpace γ] {f : γ → β} (hf : UniformEmbedding f) :
  ...
  toIsUniformInducing := UniformOnFun.postcomp_isUniformInducing hf.toIsUniformInducing
  inj _ _ H := funext fun _ ↦ hf.inj (congrFun H _)
