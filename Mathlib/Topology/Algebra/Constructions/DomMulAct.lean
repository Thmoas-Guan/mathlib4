...
@[to_additive] theorem inducing_mk : IsInducing (@mk M) := mkHomeomorphisInducing
...
@[to_additive] theorem isClosedEmbedding_mk : IsClosedEmbedding (@mk M) := mkHomeomorph.isClosedEmbedding
@[to_additive] theorem quotientMap_mk : IsQuotientMap (@mk M) := mkHomeomorph.isQuotientMap

@[to_additive] theorem inducing_mk_symm : IsInducing (@mk M).symm := mkHomeomorph.symmisInducing
...
@[to_additive]
theorem isClosedEmbedding_mk_symm : IsClosedEmbedding (@mk M).symm := mkHomeomorph.symm.isClosedEmbedding

@[to_additive]
theorem quotientMap_mk_symm : IsQuotientMap (@mk M).symm := mkHomeomorph.symm.isQuotientMap
