...
theorem Embedding.isTotallyDisconnected [TopologicalSpace β] {f : α → β} (hf : IsEmbedding f)
...
lemma Embedding.isTotallyDisconnected_image [TopologicalSpace β] {f : α → β} (hf : IsEmbedding f)
...
lemma Embedding.isTotallyDisconnected_range [TopologicalSpace β] {f : α → β} (hf : IsEmbedding f) :
